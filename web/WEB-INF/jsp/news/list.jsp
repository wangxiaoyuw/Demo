          ...
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
              <tr class="am-success">
                ...
                <th width="130px" class="table-set">详情</th>
              </tr>
            </thead>
              ...
              <tr>
               ...
               <td>
                    <div class="am-btn-toolbar">
                        <div >
                            <a href="javascript:update('${user.id}');">详情</a>
...
<script type="text/javascript">
  function update(id) {
      $(".page-content").load("/news/show/" + id);
  }
  ...
  function save() {
      $.ajax({
          url:"/news/upload",
          type:'POST',
          data:{"value1":UE.getEditor('editor').getContent()},
          success:function () {
              window.location = "/news/show";
          },
          error:function () {
              alert("false")
          }

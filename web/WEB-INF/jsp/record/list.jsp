...
<div class="admin-biaogelist page-content">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl class="am-icon-home" style="float: right;">当前位置： 首页 > <a href="#">记录列表</a></dl>
    ...
    <form >
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <tbody><c:forEach items="${list}" var="r">
              <tr>
                <td><input type="checkbox" /></td>

                <td >${r.id}</td>
                <td class="am-hide-sm-only">${r.rname}</td>
                  <td class="am-hide-sm-only">${r.record}</td>
                <td>
    ...
    <script type="text/javascript">
         function exportFile(){
                 window.location.href = "<%=request.getContextPath()%>/export";
           }
     </script>
